										...
										<table style="width: 480px; margin: 0px auto;">
											...
											<tr style="text-align: right; font-size: 10px; color: #777777;">
												<td style="padding-top: 10px; border-top: solid 1px #cccccc;">
													<a href="'.$config['site_url'].'/?unsubscribe='.$data['id'].'&um='.md5($config['site_email']).'">Unsubscribe</a> from our newsletter
												</td>
											</tr>
										</table>
									</body>
					...
					$mailer->MsgHTML('<html>
										<body style="font-family: Verdana; color: #333333; font-size: 12px;">
											<table style="width: 480px; margin: 0px auto;">
												...
												<tr style="text-align: right; font-size: 10px; color: #777777;">
													<td style="padding-top: 10px; border-top: solid 1px #cccccc;">
														<a href="'.$config['site_url'].'/?unsubscribe='.$data['id'].'&um='.md5($row['email']).'">Unsubscribe</a> from our newsletter
													</td>
												</tr>
											</table>
										</body>
